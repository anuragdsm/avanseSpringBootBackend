(function ($) {
    ...
    serviceSlider();
        ...
        /*-------------------------------------------------------------------------------
	  lifeevent_carousel js
	-------------------------------------------------------------------------------*/
    function lifeevent_carousel() {
        var lifeevent_slider = $(".lifeevent_carousel");
        if (lifeevent_slider.length) {
            lifeevent_slider.owlCarousel({
                loop: false,
                margin: 0,
                items: 2,
                autoplay: false,
    ...
    lifeevent_carousel();
        ...
        /*-------------------------------------------------------------------------------
	  jobopening_carousel js
	-------------------------------------------------------------------------------*/
    function jobopening_carousel() {
        var jobopening_slider = $(".jobopening_carousel");
        if (jobopening_slider.length) {
            jobopening_slider.owlCarousel({
                loop: false,
                margin:30,
                items: 4,
                autoplay: false,
    ...
    /*-------------------------------------------------------------------------------
	  award_carousel js
	-------------------------------------------------------------------------------*/
    function award_carousel() {
        var award_slider = $(".recognition_carousel");
